      ...
      <div className="container">
        <div className={classStyle}>
          ...
          <div className="setting">
            ...
            <span>
              <i className="icon iconfont icon-xiaoxi" />
              <p className="text">消息</p>
            </span>
            <span>
              <i className="icon iconfont icon-shezhi" />
              <p className="text">设置</p>
            </span>
          </div>
          <div className="bottom">
            <span>
              <i className="iconfont icon-lixianxiazai" />
              离线
            </span>
            <span>
              <i className="iconfont icon-yejianzhuanhuan" />
              夜间
            </span>
          </div>
        </div>
